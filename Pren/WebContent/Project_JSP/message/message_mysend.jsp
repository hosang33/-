...
<%
	...
	map.put("sendUserNo",loginedUser.getNo());
				...
				<table class="table table-striped table-bordered"
					...
					<thead>
						<tr>
							...
							<th   style="text-align: center;">내용 미리보기</th>
							<th   style="text-align: center;">전송일</th>
					...
					%>
						<tr>
							...
							<td><%=DateUtils.dateToStringPlusTime(i.getSendDate()) %></td>
							<td><%=i.getIsRead().equals("y")? "읽음" : "읽지않음" %></td>
						</tr>
					<%
							}
						}
